...
def test_load_enabled_toolsets_rejects_disabled_mcp_env(monkeypatch, capsys):
    ...
    # Sorted: ["kanban", "memory", "project", "runbook"]. `kanban` is
    # auto-recovered by _get_platform_tools (a non-configurable platform
    # toolset in hermes-cli's universe); `project` is GUI-only, folded in by
    # _load_enabled_toolsets; `runbook` is this installation's always-available
    # workflow toolset.
    ...
    expected = {"kanban", "memory", "project", "runbook"}
