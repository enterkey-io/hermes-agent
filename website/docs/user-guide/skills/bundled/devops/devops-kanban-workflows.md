---
title: "Kanban Workflows — Execute one assigned Kanban lifecycle phase safely"
sidebar_label: "Kanban Workflows"
...
Execute one assigned Kanban lifecycle phase safely.
...
| Path | `skills/devops/kanban-workflows` |
| Version | `1.0.0` |
...
Use this skill only when the dispatcher assigns a Kanban task worker. The task
card is the durable authority; your response text is not a handoff.
