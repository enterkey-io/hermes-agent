...
def _handle_list(args: dict, **kw) -> str:
    ...
    if workforce_scope not in (None, "self", "reporting_line"):
        return tool_error("workforce_scope must be self or reporting_line")
    ...
    try:
        ...
        try:
            ...
            scope_profiles = None
            if workforce_scope in {"self", "reporting_line"}:
...
KANBAN_LIST_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "workforce_scope": {
                "type": "string",
                "enum": ["self", "reporting_line"],
                "description": (
                    "Host-resolved current workforce profile only (`self`) or that "
                    "profile plus every direct and indirect report (`reporting_line`). "
