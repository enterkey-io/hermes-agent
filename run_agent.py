            ...
            try:
                ...
                if assistant_message.tool_calls:
                    ...
                    if truncated_response_parts:
                        ...
                        # "i promise*hits self*"). Adapted from the prior
                        # single-string accumulator: upstream now uses a list
                        # of parts joined here, but the gluing risk is the same.
                        prefix = "".join(truncated_response_parts)
